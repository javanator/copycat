...
public class TextureToBlockMapper {
	...
	public enum TextureMappedBlock {
		...
		WOOD_PLANK_OAK(4, Material.WOOD, (byte) 0),
		WOOD_PLANK_SPRUCE(198, Material.WOOD, (byte) 1),
		WOOD_PLANK_BIRCH(199, Material.WOOD, (byte) 2),
		WOOD_PLANK_JUNGLE(214, Material.WOOD, (byte) 3),
		...
		EMERALD_BLOCK(25, Material.EMERALD_BLOCK, (byte) 0),
